...
union YYSTYPE
{
#line 48 "../src/parse.y" /* yacc.c:355  */

  uint16_t ivalue;
  char     cvalue;

#line 167 "parse.tab.c" /* yacc.c:355  */
};
...
#line 184 "parse.tab.c" /* yacc.c:358  */
...
{
  "$end", "error", "$undefined", "\"read command\"", "\"write command\"",
  "tERROR", "tEND", "\"address\"", "\"character litteral\"", "';'",
  "$accept", "start", "commands_list", "command", YY_NULLPTR
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
        case 6:
#line 78 "../src/parse.y" /* yacc.c:1646  */
    { vmm_write ((yyvsp[-2].ivalue), (yyvsp[-1].cvalue)); }
#line 1256 "parse.tab.c" /* yacc.c:1646  */
    break;

  case 7:
#line 80 "../src/parse.y" /* yacc.c:1646  */
    { (void) vmm_read ((yyvsp[-1].ivalue)); }
...
#line 1271 "parse.tab.c" /* yacc.c:1646  */
    break;
...
#line 88 "../src/parse.y" /* yacc.c:1906  */
